...
(function() {
    ...
    var DelimitedParser = function(options) {
        options = options || {};
        ...
        this.__delimiterPatterns = getDelimiterPatterns(this.delimiter, this.quoteChar);
    };
    ...
    _.extend(DelimitedParser.prototype, {
        ...
        parse: function(data) {
            ...
            function parseDataArray(arrData, skipRows, emptyValue, firstRowIsHeader, firstColIsHeader) {
                var series = [],
                    seriesNames = {},
